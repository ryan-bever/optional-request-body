...
// ThingRequest defines model for ThingRequest.
...
type CreateThingJSONRequestBody = ThingRequest
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("POST "+options.BaseURL+"/things", wrapper.CreateThing)
...
type CreateThing201Response struct {
}

func (response CreateThing201Response) VisitCreateThingResponse(w http.ResponseWriter) error {
	w.WriteHeader(201)
	return nil
}
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/2yQz276MAzHXyXy73csbRm3HLfTrhMvEFJDg2jsOQYNob775BSYJu1Up5a/fz43iDQx",
	"ZcxawN+gxBGnUMftmPLhAz/PWNTeLMQomrBuc5jQvgOWKIk1UQYP2xGdbRztnY7o1DSgAb0ygoeisry/",
	"ViQDCvj1PD+3tDtiVJjtV8p7MnlNeqo7xhw4rSINeMDsTCmqKygXFEfVP5ycLHHdjoYrNHBBKUuwvu3b",
	"NczNQwg8bNq+3UADHHSslbqato5MS2drHEz7fQAPb4JBcXvvdPd6NStvHLNirleB+ZRiveuOxfwfYG36",
	"L7gHD/+6H/LdHXv3i/lcSQgWplwW6i/9+i/oKR9crOEGsJtynqYg12dkt2Q2we8AAAD//881IAHxAQAA",
}
